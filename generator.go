...
func randomHexDigit() string {
	parts := strings.Split(HEX_DIGITS, "")
	return randomElement(parts)
}
 ...
 */
func _randomString(length int, character string) string {
	result := ""
	characters := strings.Split(character, "")
 ...
 */
func _hasTemplate(s string) bool {
